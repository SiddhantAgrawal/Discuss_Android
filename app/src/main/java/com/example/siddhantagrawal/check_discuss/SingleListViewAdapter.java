...
public class SingleListViewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View itemView = inflater.inflate(R.layout.listview_answer, parent, false);
        // Get the position
        specific_answer = answers_data.get(position);

        // Locate the TextViews in listview_item.xml
        answer_text = (TextView) itemView.findViewById(R.id.answer_text);
        answer_likes = (TextView) itemView.findViewById(R.id.answer_likes_button);


        // Locate the ImageView in listview_item.xml
        answer_image = (ImageView) itemView.findViewById(R.id.answer_image);
